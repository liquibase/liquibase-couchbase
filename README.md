...
The guide how you can run liquibase using spring boot starter you can see in the [spring-boot-test-project](spring-boot-test-project) directory. This project contains all necessary files to run.
