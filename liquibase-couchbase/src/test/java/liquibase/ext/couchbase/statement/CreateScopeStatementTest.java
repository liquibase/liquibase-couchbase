...
public class CreateScopeStatementTest {
    ...
    @Test
    void Should_call_createScope() {
        CreateScopeStatement statement = new CreateScopeStatement(TEST_SCOPE, TEST_BUCKET);
        ...
        verify(bucketOperator).createScope(TEST_SCOPE);
    }
