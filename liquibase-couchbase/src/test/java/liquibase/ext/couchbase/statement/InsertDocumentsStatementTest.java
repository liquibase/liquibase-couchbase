...
public class InsertDocumentsStatementTest {
    ...
    void Should_execute_in_transaction() {
        InsertDocumentsStatement statement = new InsertDocumentsStatement(TEST_KEYSPACE, documents);

        statement.doInTransaction(transaction, clusterOperator);

        verify(collectionOperator).insertDocsTransactionally(transaction, documents);
    }
    ...
    void Should_execute_in_transaction_reactive() {
        ...
        when(collectionOperator.insertDocsTransactionallyReactive(reactiveTransactionAttemptContext,
        ...
        verify(collectionOperator).insertDocsTransactionallyReactive(reactiveTransactionAttemptContext, documents);
    }
}