...
/**
 *
 * An interface for providing context information for different services of the extension.
 * Responsible for working with the service bucket and its collections in the corresponding scopes.
 *
